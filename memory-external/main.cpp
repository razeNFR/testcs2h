...
int main() {
	SetConsoleTitle("CS2Hack 0.2");
	std::cout << "[WebSite] http://counterstrike-hack.leforum.eu/" << std::endl;
	...
	std::cout << "\n[settings] In Game keybinds:\n\t[F5] enable/disable Team ESP\n\t[F7] enable/disable extra flags\n\t[end] Unload esp\n" << std::endl;
#endif
	std::cout << "[settings] Make sure you check the config.json file for additional settings!" << std::endl;
